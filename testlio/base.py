...
class TestlioAutomationTest(unittest.TestCase):
    ...
    def get_clickable_element(self, **kwargs):
        ...
        try:
            if kwargs.has_key('name'):
                return wait.until(EC.element_to_be_clickable((By.ID, kwargs['name'])))
    ...
    def get_element(self, **kwargs):
        ...
        try:
            if kwargs.has_key('name'):
                return wait.until(EC.presence_of_element_located((By.ID, kwargs['name'])))
            elif kwargs.has_key('class_name'):
    ...
    def get_elements(self, **kwargs):
        ...
        try:
            if kwargs.has_key('name'):
                return wait.until(EC.presence_of_all_elements_located((By.ID, kwargs['name'])))
            elif kwargs.has_key('class_name'):
    ...
    def _find_element(self, **kwargs):
        ...
        if kwargs.has_key('name'):
            return self._find_element_by_id(kwargs['name'])
        elif kwargs.has_key('class_name'):
